    ...
    <article className='card'>
      ...
      <section className='card__body'>
        ...
        <ul className='card__list'>
          <li className='card__item'><span className='card__span'>Ethnicity :</span>{resident?.species}</li>
          <li className='card__item'><span className='card__span'>Origin: </span>{resident?.origin.name}</li>
          <li className='card__item'><span className='card__span'>Appears in: </span>{resident?.episode.length} episode{resident?.episode.length > 1 ? 's' : ''}</li>
        </ul>
      </section>
    </article>
  )
